...
let btnSession = querySelector('.login-btn')
let email = getEBI('email-input')
let pwd = getEBI('password-input')
let loader = getEBI('loader')
let error = getEBI('error-container')

btnSession.addEventListener('click',function(ev){
