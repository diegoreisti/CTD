...
consultandoBaseDeDados
 ...
 const renderizarDadosUsuario = (dados) => {

        const tarjeta = document.getElementById('tarjeta')
    
        dados.forEach(usuario => {
            tarjeta.innerHTML += `
             <img src=${usuario.imagem.grande}>
              <p>${usuario.nome.titulo}. ${usuario.nome.primeiro} ${usuario.nome.utlimo}</p>
              <p>${usuario.celular}</p>
              <p>${usuario.email}</p>
...
//     let fullName = dados['resultado'][0]['nome'].titulo
//         + ' ' +
//         dados['resultado'][0]['nome'].primeiro
//         + ' ' +
//         dados['resultado'][0]['nome'].ultimo


//     nome.innerHTML = fullName.toLocaleUpperCase()


//     img.src = dados['resultado'][0]['imagem'].grande;

//     pEmail.innerHTML = dados['resultado'][0]['email'];
